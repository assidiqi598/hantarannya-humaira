...
export default function ImgPage({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative flex items-center opacity-0 animate-fadeup",
          {
      ...
      {!loading && (
        ...
        >
          <p className="portrait:mt-2 lg:text-xl">
            Tipe: {type}
          </p>
          <p className="portrait:mt-2 lg:text-xl mt-6">
            Tema: {theme}
          </p>
          {desc && desc !== "undefined" && (
            <>
              {linkTarget && linkHref ? (
                ...
                <span className="portrait:mt-2 mt-6 lg:text-lg">
                  {replace(desc)}
                </span>
              )}
            </>
